...
const PROJECT_MAPPINGS: ProjectMapping[] = [
  ...
  {
    fileName: "BHS",
    organizationId: "org-lamps",
    projectName: "Brittany Hill Studios",
  },
  ...
  // VillageX
  {
    fileName: "VillageX.app",
    organizationId: "org-villagex",
    projectName: "VillageX App",
  },
  ...
  // Client Projects
  {
    fileName: "Kens Solar Installation",
    organizationId: "org-clients",
    projectName: "Ken's Solar Installation",
  },
  {
    fileName: "Randys Solar System",
    organizationId: "org-clients",
    projectName: "Randy's Solar System",
  },
  {
    fileName: "Sunriver Womens Association",
    organizationId: "org-clients",
    projectName: "Sunriver Women's Association",
  },
...
export async function migrateTodoistData(backupDir: string): Promise<Database> {
  ...
  for (const filePath of files) {
    ...
    try {
      ...
      const mapping = PROJECT_MAPPINGS.find((m) =>
        fileName.startsWith(m.fileName),
      );
      if (!mapping) {
      ...
      if (fileName === "TPC") {
        ...
        const project: Project = {
          ...
          color:
            mapping.color ||
            PROJECT_COLORS[projectCounter % PROJECT_COLORS.length],
          organizationId: mapping.organizationId,
          isFavorite: false,
          todoistId: filePath,
          createdAt: now,
  ...
  console.log(
    `Migration complete! Imported ${database.projects.length} projects and ${database.tasks.length} tasks.`,
  );
  ...
  return [
    {
      ...
      color: ORGANIZATION_COLORS["The Portland Company"],
    },
    {
      id: "org-lamps",
      name: "Buy Some Lamps",
      color: ORGANIZATION_COLORS["Buy Some Lamps"],
    },
    {
      id: "org-politogy",
      name: "Politogy VRM",
      color: ORGANIZATION_COLORS["Politogy VRM"],
    },
    {
      id: "org-villagex",
      name: "VillageX",
      color: ORGANIZATION_COLORS["VillageX"],
    },
    {
      id: "org-personal",
      name: "Personal",
      color: ORGANIZATION_COLORS["Personal"],
    },
    {
      id: "org-property",
      name: "Property",
      color: ORGANIZATION_COLORS["Property"],
    },
    {
      id: "org-clients",
      name: "Client Projects",
      color: ORGANIZATION_COLORS["Client Projects"],
    },
  ];
}
...
function createUser(todoistUser: TodoistUser): User {
  ...
  const nameData = names[todoistUser.name] || {
    first: todoistUser.name,
    last: "",
  };
...
function createTask(
  ...
  const task: Task = {
    ...
    deadline: todoistTask.deadline
      ? parseDueDate(todoistTask.deadline)
      : undefined,
