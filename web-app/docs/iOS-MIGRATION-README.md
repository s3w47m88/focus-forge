# iOS Migration Guide - Focus: Forge

This guide outlines a zero-risk approach to adding iOS support to the Focus: Forge task management application while preserving the existing web application.
