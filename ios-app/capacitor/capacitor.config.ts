...
const serverTargets = {
  ...
  staging: process.env.CAPACITOR_STAGING_URL || 'https://focusforge.theportlandcompany.com',
  production:
    process.env.CAPACITOR_PRODUCTION_URL || 'https://focusforge.theportlandcompany.com'
};
...
const config: CapacitorConfig = {
  appId: 'com.theportlandcompany.focusforge',
  appName: 'Focus: Forge',
  webDir: 'dist',
  ios: {
